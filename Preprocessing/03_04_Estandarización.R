...
MES2021_ORI <- read.table(file_path, sep = "," , header = T , na.strings ="", stringsAsFactors= F)
...
MES2021_ORI$FECHA_DEF[MES2021_ORI$FECHA_DEF=="9999-99-99"]<-""  #MES2021_ORI$OTRO_CASO[MES2021_ORI$OTRO_CASO==99]<-0
...
write.csv(MES2021_ORI,"C:/COVID/ENT/06COL/2020/YEAR2020_colima.csv",row.names=FALSE)